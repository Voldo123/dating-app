Отличный проект! Просканировал твой репозиторий. Да, это типичный Laravel + Vite + Inertia + Vue.js проект. Вот подробная инструкция, которая позволит полностью развернуть его на локальной машине.
